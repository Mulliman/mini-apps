...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-sky-100 to-blue-200 flex flex-col items-center justify-center p-4 overflow-hidden selection:bg-transparent">
